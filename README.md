...
- **Розклад** — календар на тиждень і місяць, заняття за типами, проведення заняття з відміткою явки.
- **Журнал оцінок** — таблиця «студенти × заняття» з редагуванням просто в клітинці та масове виставлення оцінок за заняття.
